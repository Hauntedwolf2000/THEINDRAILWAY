            ...
            <MDBCard className="mb-5" style={{ borderRadius: '15px' }}>
              <MDBCardBody className="p-4">
                ...
                <MDBCardText className="small">
                  ...
                  <h2>Train Details</h2>
    {trainDetails && (
        <div className='fs-5 p-2 bg-light border'>
          Train No: {trainDetails.train_number}, Train Name: {trainDetails.train_name},
          Departure Time: {trainDetails.departure_time}, Arrival Time: {trainDetails.arrival_time}
        </div>
      )}
          ...
          <ul>
            {intermediateStops.map((stop) => (
              <li className='fs-5 p-2 bg-light border' key={stop.stop_id}>
                Station: {stop.station_name}, Arrival Time: {stop.arrival_time}, Departure Time: {stop.departure_time}
              </li>
            ))}
          </ul>
      </ul></strong>
